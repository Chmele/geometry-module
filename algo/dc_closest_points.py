...
def closest_pair_split(points_sorted_x: List[Point], points_sorted_y: List[Point], delta: float):
    ...
    points_sorted_x = list(filter(lambda point: point.dist_to_point(middle_point) <= delta, points_sorted_x))
    left_points_x = list(filter(lambda point: point.x <= middle_point.x, points_sorted_x)) 
    right_points_x = list(filter(lambda point: point.x > middle_point.x, points_sorted_x)) 
